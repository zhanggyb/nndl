...
\begin{document}
  \begin{tikzpicture}[
    inputlayer/.style={rectangle,draw,fill=white,inner sep=0pt,minimum size=60mm},
    hiddenlayer/.style={rectangle,draw,fill=white,inner sep=0pt,minimum size=50mm}
    ]

    \node (input) [inputlayer,anchor=south west] at (0,0) {};

    \node (hidden0) [hiddenlayer,anchor=south west] at (8,0) {};
