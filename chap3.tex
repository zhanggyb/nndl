...
举出来。在本节，我简要地给出三种减轻\gls*{overfitting}的其他的方法：L1 \gls*{regularization}、弃权和人为
...
和 L1、L2 \gls*{regularization}不同，弃权技术并不依赖对\gls*{cost-func}的修改。而是，在弃权中，我们改变
...
样看来，弃权和 L1、L2 \gls*{regularization}也是有相似之处的，这也倾向于更小的\gls*{weight}，最后让网络对
丢失个体连接的场景更加健壮。
...
最好的结果是在测试集上取得了 98.4\% 的准确率。他们使用弃权和 L2 \gls*{regularization}的组合将其
